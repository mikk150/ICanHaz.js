...
!d?b.$(g(e)):e})},clearAll:function(){for(var a in b.templates)delete b[a];b.templates={}},refresh:function(){b.clearAll();b.grabTemplates()},grabTemplates:function(){var a,d,e=document.getElementsByTagName("script"),c,f=[];a=0;for(d=e.length;a<d;a++)(c=e[a])&&c.innerHTML&&c.id&&("text/html"===c.type||"text/x-icanhaz"===c.type)&&(b.addTemplate(c.id,g(c.innerHTML)),f.unshift(c));a=0;for(d=f.length;a<d;a++)f[a].parentNode.removeChild(f[a])}};"undefined"!==typeof exports?("undefined"!==typeof module&&
